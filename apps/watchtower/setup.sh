...
CONFIG_DIR="${CALEOPE_BASE_DIR}/app-config/watchtower"
...
[ -n "${CALEOPE_PARAM_WATCHTOWER_SCHEDULE:-}" ] && WATCHTOWER_SCHEDULE="${CALEOPE_PARAM_WATCHTOWER_SCHEDULE}"
[ -n "${CALEOPE_PARAM_WATCHTOWER_CLEANUP:-}" ] && WATCHTOWER_CLEANUP="${CALEOPE_PARAM_WATCHTOWER_CLEANUP}"
[ -n "${CALEOPE_PARAM_WATCHTOWER_INCLUDE_STOPPED:-}" ] && WATCHTOWER_INCLUDE_STOPPED="${CALEOPE_PARAM_WATCHTOWER_INCLUDE_STOPPED}"
