...
CONFIG_DIR="${CALEOPE_APP_CONFIG}/linkding"
_SECRETS="${CONFIG_DIR}/secrets.env"

mkdir -p "${CONFIG_DIR}"
mkdir -p "${CALEOPE_APP_DATA}/linkding/data"
...
[ -n "${PARAM_LINKDING_ADMIN_USER:-}" ] && LINKDING_ADMIN_USER="${PARAM_LINKDING_ADMIN_USER}"
[ -n "${PARAM_LINKDING_ADMIN_PASS:-}" ] && LINKDING_ADMIN_PASS="${PARAM_LINKDING_ADMIN_PASS}"
[ -n "${PARAM_LINKDING_PORT_WEB:-}"   ] && LINKDING_PORT_WEB="${PARAM_LINKDING_PORT_WEB}"
