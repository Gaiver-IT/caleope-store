...
if [ -d "${CALEOPE_BASE_DIR}/apps-installed/authentik" ]; then
    if authentik_register_app "n8n" "n8n" "https://n8n.${BASE_DOMAIN}"; then
...
n8n est démarré.
Interface : http://<IP>:${N8N_PORT_WEB}

Créer un compte admin à la première connexion.
Webhook URL : https://n8n.${BASE_DOMAIN}/
INFO

echo "✓ n8n prêt — http://<IP>:${N8N_PORT_WEB}"
